//EXERCISE START HERE!
function simpleXMLHttpRequest(method, url, search){
	...
	var promise = new Promise(function(resolve, rejected){
		...
		var request = new XMLHttpRequest();
 		var completeUrl = url + search;
 		request.open(method, completeUrl);
...
var myObject = {
 ...
 function buscarRepositorio(){
	...
	var newSimpleRequest = simpleXMLHttpRequest(myObject.oMethod, myObject.oURL, nombreRepo);
